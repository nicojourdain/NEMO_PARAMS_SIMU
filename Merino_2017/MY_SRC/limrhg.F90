...
!                  &        / ( 1.0 + alphaevp*ecc2*dtotel )
              zs1(ji,jj) = zs1(ji,jj)  &
                  &          - dtotel*( zs1(ji,jj) +    &
                  &            ( delta / deltat(ji,jj) - zdd(ji,jj) / &
                              deltat(ji,jj) ) * zpresh(ji,jj))

              zs2(ji,jj) = zs2(ji,jj)  &
                 &          - dtotel*( zs2(ji,jj)  -  zdt(ji,jj)  /  &
                 &          (     ecc2*deltat(ji,jj) ) * zpresh(ji,jj))
...
!                  &         / ( 1.0 + alphaevp*ecc2*dtotel ) 
               zs12(ji,jj) = zs12(ji,jj) &
                  &           - dtotel*( zs12(ji,jj) - zds(ji,jj) / &
                  &          ( 2.0*ecc2*deltac(ji,jj) ) * zpreshc(ji,jj))
