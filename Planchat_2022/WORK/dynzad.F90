...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: dynzad.F90 5189 2015-03-31 17:58:23Z mathiot $
...
CONTAINS
   ...
   SUBROUTINE dyn_zad ( kt )
      ...
      !                             ! Vertical momentum advection at uw and vw-points
      DO jk = 2, jpk                
         DO jj = 2, jpj                   ! vertical fluxes 
            ...
            END DO
         END DO
         DO jj = 2, jpjm1                 ! interior vertical momentum advection at w-point
            DO ji = fs_2, fs_jpim1
         ...
         END DO   
      END DO
      DO jj = 2, jpjm1                    ! First/last level advective fluxes
         DO ji = fs_2, fs_jpim1           ! w is zero at k=1 and k=jpk
            zwuw(ji,jj, 1 ) = 0._wp
            zwvw(ji,jj, 1 ) = 0._wp
